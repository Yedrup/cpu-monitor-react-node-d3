...
const getLoadAverageByCpu = (loadAverageArr) => {
  return loadAverageArr.map((loadAv) =>
    parseFloat((loadAv / CPUS_COUNT).toPrecision(AVERAGE_PRECISION))
  );
};
...
app.get('/api/cpu/averages', (req, res) => {
  ...
  let loadAverageByCpu_1_5_10 = getLoadAverageByCpu(
    LOAD_AVERAGE_LAST_1_5_15_MINS
  );
